...
SPI1 Clock (SCK): Pin 13
SPI1 MOSI:        Pin 11
SPI1 MISO:        Pin 12
SPI1 Chip Select: Pin 10
*/
...
// Function prototype
uint8_t SPI1Write(uint8_t sendByte);
...
uint16_t readEncoder()
{
    ...
    currentPosition = (SPI1Write(nop) & 0x0F) << 8;
    currentPosition |= SPI1Write(nop);
